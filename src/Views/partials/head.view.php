...
<head>
    ...
    <title>the_shop_farwest</title>
    <link rel="shortcut icon" href="logo/petite icone phenix.png" type="logo/petite icone phenix.png">
      ...
      <ul class="navbar-nav">
        <?php
          if(isset($_SESSION['user'])){?>
            <li class="nav-item">
            <a class="nav-link" href="/ajoutPresentation">Ajouter une presentation</a>
          </li>
          <li class="nav-item">
